...
function appendDeletePaymentBtn(tr) {
  const deletePaymentBtn = document.createElement("td");
  deletePaymentBtn.innerText = "X";

  deletePaymentBtn.addEventListener("click", function(evt) {
